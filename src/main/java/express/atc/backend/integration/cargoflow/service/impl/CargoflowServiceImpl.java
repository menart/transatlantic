...
public class CargoflowServiceImpl implements CargoflowService {
    ...
    @Override
    public TrackingDto getInfoByTrackNumber(String trackNumber) {
        return getTrackingInfoFromCargoflow(trackNumber);
    }

    private TrackingDto getTrackingInfoFromCargoflow(String trackNumber) {
        ...
        var trackingDto = cargoflowOrderWebClient
                .post()
